...
find_path(GYSANG_GYMPL_INCLUDE_DIR NAMES "${gympl_main_header}" PATHS "${gympl_main_header_expected_path}")
...
#message("doFindGympl: GYSANG_GYMPL_INCLUDE_DIR: ${GYSANG_GYMPL_INCLUDE_DIR}")
#message("doFindGympl: CMAKE_CURRENT_SOURCE_DIR: ${CMAKE_CURRENT_SOURCE_DIR}")

if((NOT GYSANG_GYMPL_INCLUDE_DIR) OR (NOT EXISTS ${GYSANG_GYMPL_INCLUDE_DIR}))
...
if((NOT GYSANG_GYMPL_INCLUDE_DIR) OR (NOT EXISTS ${GYSANG_GYMPL_INCLUDE_DIR}))
	...
	set(GYMPL_CPP_STD "${GYSANG_CPP_STD}")
endif()
